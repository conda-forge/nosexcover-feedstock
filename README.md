About nosexcover-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nosexcover-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/cmheisel/nose-xcover/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4670&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nosexcover-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nosexcover` can be installed with `conda`:
...
```
mamba install nosexcover
```

It is possible to list all of the versions of `nosexcover` available on your platform with `conda`:
...
```
mamba search nosexcover --channel conda-forge
```
...
mamba repoquery search nosexcover --channel conda-forge

# List packages depending on `nosexcover`:
mamba repoquery whoneeds nosexcover --channel conda-forge

# List dependencies of `nosexcover`:
mamba repoquery depends nosexcover --channel conda-forge
```
